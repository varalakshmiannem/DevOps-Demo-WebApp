    ...
    stage('DeployToTest') {
      ...
      post {
        ...
        success {
          ...
          deploy adapters: [tomcat8(credentialsId: 'tomcat', path: '', url: 'http://34.122.211.73:8080/')],
    ...
    stage('DeployToProd') {
      ...
      post {
        ...
        success {
          ...
          deploy adapters: [tomcat8(credentialsId: 'tomcat', path: '', url: 'http://34.66.31.184:8080/')],
