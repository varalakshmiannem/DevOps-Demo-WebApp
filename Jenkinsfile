    ...
    stage('DeployToTest') {
      ...
      post {
        ...
        success {
          ...
          deploy adapters: [tomcat8(credentialsId: 'tomcat', path: '', url: 'http://34.66.70.228:8080/')],
    ...
    stage('DeployToProd') {
      ...
      post {
        ...
        success {
          ...
          deploy adapters: [tomcat8(credentialsId: 'tomcat', path: '', url: 'http://34.72.244.162:8080/')],
