    ...
    stage('DeployToTest') {
      ...
      post {
        ...
        success {
          ...
          deploy adapters: [tomcat8(credentialsId: 'tomcat', path: '', url: 'http://34.66.156.76:8080/')],
    ...
    stage('DeployToProd') {
      ...
      post {
        ...
        success {
          ...
          deploy adapters: [tomcat8(credentialsId: 'tomcat', path: '', url: 'http://34.123.26.129:8080/')],
